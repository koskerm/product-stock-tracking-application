<?php
	...
	if(!isset($_SESSION['user_id'])){
		...
		if($_SESSION['user_rank'] == 2){
			$dashboard = '<li><a class="dropdown-item" href="dashboard.php">Yönetim Paneli</a></li>';
		}
		else{
			$dashboard = '';
		}
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light border-bottom bg-white">
		<div class="container">
			<a class="navbar-brand" href="index.php">Stok APP / Anasayfa</a>
